...
⚡ I've been **TA** @ **IIT Madras**,  **Generative AI Engineer** @ **Outlier AI** <br>
<br>
...
| [Lift Simulation](https://github.com/pradeepmondal/lift-simulation) | Web app simulating a real-world multiplayer lift system using advanced CSS and JavaScript. |  
| [MAD1 LMS](https://github.com/pradeepmondal/MAD1-LMS) | Learning Management System built as the MAD1 capstone project @ IIT Madras. |  
...
| [Live Coding TA Sessions](https://github.com/pradeepmondal/live-coding-ta-sessions) | Code from live TA sessions for IIT Madras courses (Flask, Vue.js, Celery, Redis). |  
